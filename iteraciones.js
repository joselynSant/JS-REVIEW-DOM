window.onload = () => {
    ...
    const dog = [
        {title: 'whatever title', imgUrl: 'https://picsum.photos/id/237/200/300?whatever=1'}, 
        {title: 'whatever title', imgUrl: 'https://picsum.photos/id/237/200/300?whatever=2'},
        {title: 'whatever title', imgUrl: 'https://picsum.photos/id/237/200/300?whatever=3'},
        {title: 'whatever title', imgUrl: 'https://picsum.photos/id/237/200/300?whatever=4'},
        {title: 'whatever title', imgUrl: 'https://picsum.photos/id/237/200/300?whatever=5'}
    ];
    
    dog.forEach((country) => {
        let newDiv = document.createElement("div")
        let newH4 = document.createElement("h4")
        newH4.innerText = dog.title
        let newImg = document.createElement("img")
        newImg.setAttribute("src", dog.imgUrl)
